...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/backend/css/maan-custom.css') }}">
    <style>
        #preloaderimage{
            height: 60px;
            width: 60px;
...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" id="preloaderimage" src="{{ asset($settings->favicon) }}" alt="AdminLTELogo" >
    </div>
...
@if(\Route::current()->getName() != 'admin.dashboard')
    ...
    <link rel="stylesheet" href="{{ asset('public/backend/plugins/sweetalert2/animate.min.css') }}"/>
