                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('Banner Edit') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header col-12 row ">
                                ...
                                <div class="col-10">
                                    <h3 class="card-title">{{ __('Banner Edit') }}</h3>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('admin.banner.update',$banner->id) }}" onsubmit="onSubmitUpdate()" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-sm" id="submint">{{ __('update') }}</button>
                                    </div>
                                </form>
