            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="section-title">
                        {{-- subtitle --}}
                        <h5 class="subtitle">{{ __('AWESOME') }}</h5>
                        {{-- title --}}
                        <h2 class="title">{{ __('Choose Your Panel') }}</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="inner-item style-large">
                        <a href="{{ route('admin.dashboard') }}"><span class="thumb"><img src="{{ asset('public/frontend/demo-landing/img/admin_panel.png') }}" alt="img"></span>{{ __('Admin Panel') }}</a>
