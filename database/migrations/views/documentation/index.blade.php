    ...
    <header class="header">
		<div class="col-xl-12">
			...
			<div class="navbar navbar-expand-sm bsnav bsnav-sticky bsnav-scrollspy">
					<div class="container">
						<a class="navbar-brand" href="#home"><img src="{{ asset('public/documentation/assets/img/maan-news-logo.png') }}" alt="thumb"></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="item">
                        ...
                        <ul>
                            <li><strong>Created:</strong> 20/08/2022</li>
                            <li><strong>By:</strong> <a target="_blank" href="{{ asset('') }}">Walaazidan</a></li>
                            <li><strong>Email:</strong> <a href="mailto:walaahassan2021@gmail.com">walaahassan2021@gmail.com</a></li>
                        </ul>
