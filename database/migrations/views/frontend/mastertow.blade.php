...
<head>
    ...
    {{-- favicon icon --}}
    <link rel=icon href="{{ asset(config('app.icon')) }}" sizes="20x20" type="image/png">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 align-self-center">
                    <a href="{{URL('/') }}"><img src="{{ asset(config('app.logo1')) }}" alt="img"></a>
                </div>
                <div class="col-md-8 text-md-right align-self-center mt-lg-0 mt-3">
                    <p>{{ __('© 2021 walaazidan. All Rights Reserved.') }}</p>
                </div>
            </div>
        </div>
    </div>
