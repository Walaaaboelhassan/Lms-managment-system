    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- form start -->
                <form method="POST" action="{{route('admin.role')}}" onsubmit="onSubmitInsert()"  enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="slug" id="slug" placeholder="Enter slag" value="{{old('slug')}}" required>
                            </div>
