                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="form-control" name="user_type" id="user_type"  required>
                                                            ...
                                                            <option value="{{ __('2') }}"@if($user->user_name==2) selected @endif>{{ __('Super Admin') }}</option>
                                                            <option value="{{ __('1') }}"@if($user->user_name==1) selected @endif>{{ __('Admin') }}</option>
                                                            <option value="{{ __('0') }}" @if($user->user_name==0) selected @endif>{{ __('Instructor') }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" name="email" id="email" placeholder="Enter slag" value="{{ $user->email }}" required>
                                            </div>
                                            <div class="form-group">
...
@section('js_content')
    ...
    <script src="{{ asset('backend/js/custom-ajax.js') }}" type="text/javascript"></script>
    <script>
        "use strict";
